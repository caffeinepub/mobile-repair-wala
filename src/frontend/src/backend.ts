...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async addToCart(arg0: ProductId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getCartContents(): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<boolean> {
        if (this.processError) {
            try {
